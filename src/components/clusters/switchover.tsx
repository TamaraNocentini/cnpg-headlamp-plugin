...
import { ActionButton, ConfirmDialog } from '@kinvolk/headlamp-plugin/lib/CommonComponents';
  ...
  return (
    <>
      ...
      <ConfirmDialog
        ...
        description={
          <>
            This promotes <strong>{replicaName}</strong> to primary and demotes the current
            primary to a replica. <strong>Applications will briefly lose connectivity to the database
            while the switchover completes</strong>. Do you want to continue?
          </>
        }
        onConfirm={() => {
          setOpen(false);
